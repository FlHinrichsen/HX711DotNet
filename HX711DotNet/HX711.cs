...
namespace HX711DotNet
{
  ...
  public class HX711 : IHX711
  {
    ...
    public HX711(GpioController controller, byte dout, byte pdSck, byte gain = 128)
    {
      ...
      controller.OpenPin(pdSck, PinMode.Output);
      controller.OpenPin(Dout, PinMode.Input);
    ...
    public void PowerDown()
    {
      ...
      lock (_readLock)
      {
        ...
        //powered down.
        WriteBool(PdSck, false);
        WriteBool(PdSck, true);
        Thread.Sleep(100);
    ...
    {
      PinValue valueRead = controller.Read(Dout);
    ...
    private byte ReadNextBit()
    {
      ...
      WriteBool(PdSck, true);
      WriteBool(PdSck, false);
      PinValue value = controller.Read(Dout);
      return value == PinValue.High ? (byte)1 : (byte)0;
    }

    private void WriteBool(int pin, bool value)
    {
    ...
    private int ReadInt()
    {
      ...
      var twosComplementValue = ((dataBytes[0] << 16) | (dataBytes[1] << 8) | dataBytes[2]);
